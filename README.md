...
## Rules
 ...
 - Due to the nature of hiding lots of functionality behind APIs, you cannot have any incoming network requests.
 - You are allowed to use **1 library**, however the library must be hard coded into a script tag and must still fit under the 1MB file size threshold. (I suggest using something like [JSCompress](https://jscompress.com/)).
